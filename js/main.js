...
$("#forEg").on("submit", function(){
    ...
    monto = parseFloat($("#montoEg").val());
    suma = parseFloat($("#sumaEg").text());
    suma += monto;
    ...
    localStorage.setItem("sumaEg", suma);
    actualizarBalance()
...
function egresarDato(){
    let egresos = monto;
    localStorage.setItem("egresar", egresos);

}

$(document).ready(function() {
    let ingresosGuardados = localStorage.getItem("sumaIn");
...
$(document).ready(function() {
    let egresosGuardados = localStorage.getItem("sumaEg");
...
function actualizarBalance() {
    let sumaIn = parseFloat(localStorage.getItem("sumaIn"));
